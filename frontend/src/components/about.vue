...
const features = [
  {
    ...
    description:
        'Централизованное хранение информации о пациентах с патологиями из всех регионов России',
  },
  {
    icon: Users,
    title: 'Связь пациент-врач',
    description:
        'Прямая коммуникация между пациентами и специалистами своего региона',
  },
  {
    icon: Shield,
    title: 'Защита данных',
